...
async function handleUpload() {
  ...
  fileEntries.value.forEach(async (fileEntry, i) => {
    ...
    xhr.addEventListener("load", () => {
      fileEntries.value[i].url = `${location.origin}/embed/${newUpload.id}`;
    ...
    >
        ...
        >
          <div class="upload-form__file-name">
            ...
            <input
              ...
              @change="(e) => fileEntries[index].name = (e.currentTarget as HTMLInputElement).value"
            />
            <div
      ...
      <div class="upload-form__buttons">
        <label class="upload-form__button">
          Select files
          <input multiple type="file" value="" @change="handleFileSelect" />
        </label>
        <button
          v-if="uploading"
